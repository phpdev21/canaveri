	...
	*/
	...
	function get_displayable_columns()
	{
		$columns = array(
			...
			'supplier_type' => 								array('sort_column' => 'supplier_type ','label' => lang('suppliers_supplier_type')),
			'state_regulatory_agency_number' => 								array('sort_column' => 'state_regulatory_agency_number','label' => lang('suppliers_state_regulatory_agency_number')),
