...
abstract class Ecom extends CI_Model
{
	...
	*/
	...
	function link_item($item_id, $ecommerce_product_id, $ecommerce_product_safe,$ecommerce_product_floor, $ecommerce_last_modified)
	{
			$this->db->where('item_id', $item_id);
			$this->db->update('items', array(
				'ecommerce_product_id' => $ecommerce_product_id,
				'ecommerce_product_safe' => $ecommerce_product_safe,
				'ecommerce_product_floor' => $ecommerce_product_floor,
				'ecommerce_last_modified' => $ecommerce_last_modified,
				'last_modified' => $ecommerce_last_modified,
			));
	}
