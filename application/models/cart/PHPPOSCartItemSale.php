...
class PHPPOSCartItemSale extends PHPPOSCartItem
{
	...
	{						
		...
		if ($this->variation_id)
		{
			...
			$item_location_quantity = $CI->Item_variation_location->get_location_floor_quantity($this->variation_id);
		}
		else
		{
			$item_location_quantity = $CI->Item_location->get_location_floor_quantity($item_id);
		}
