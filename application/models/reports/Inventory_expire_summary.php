...
class Inventory_expire_summary extends Report
{
	...
	public function getDataColumns()
	{
		...
		$columns[] = array('data'=>lang('common_source_package_number'), 'align'=> 'right');
		$columns[] = array('data'=>lang('common_package_number'), 'align'=> 'right');
		...
		$columns[] = array('data'=>lang('common_safe'), 'align'=> 'left');
		$columns[] = array('data'=>lang('common_floor'), 'align'=> 'left');
	...
	public function getData()
	{
		...
		SUM(safe)  as safe,SUM(floor)  as floor, 
