...
class Summary_tiers extends Report
{
	...
	public function getDataColumns()
	{
        ...
        $columns[] = array('data'=>lang('common_amount'), 'align'=> 'right');
	...
	public function getOutputData()
	{
		...
		foreach($report_data as $row)
		{
			...
			$data_row[] = array('data'=>to_currency($row['tier_amount']), 'align'=>'right');
	...
	{		
		$this->db->select('COUNT(tier_id) as count, price_tiers.name as tier_name, SUM(total) as tier_amount');
		$this->db->from('sales'); 
