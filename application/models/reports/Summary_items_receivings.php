...
class Summary_items_receivings extends Report
{
	...
	{		
		...
		{
			$quantities_indexed_by_id[$quan_row['item_id']]['safe'] = $quan_row['safe'];
			$quantities_indexed_by_id[$quan_row['item_id']]['floor'] = $quan_row['floor'];
		}
		
		for($k=0;$k<count($items_receivings_data);$k++)
		{
			$items_receivings_data[$k]['safe'] = $quantities_indexed_by_id[$items_receivings_data[$k]['item_id']]['safe'];
			$items_receivings_data[$k]['floor'] = $quantities_indexed_by_id[$items_receivings_data[$k]['item_id']]['floor'];
		}
		...
		if (isset($this->params['items_to_show']) && ($this->params['items_to_show'] == 'items_without_receivings'))
		{
			...
			{
				$items_in_report_without_receivings[$k]['safe'] = $quantities_indexed_by_id[$items_in_report_without_receivings[$k]['item_id']]['safe'];
				$items_in_report_without_receivings[$k]['floor'] = $quantities_indexed_by_id[$items_in_report_without_receivings[$k]['item_id']]['floor'];
			}			
		}
