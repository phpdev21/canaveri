...
class Summary_items_price_variance extends Report
{
	...
	public function getData()
	{
		...
		{
			$items_sales_data[$k]['safe'] = $quantities_indexed_by_id[$items_sales_data[$k]['item_id']]['safe'];
			$items_sales_data[$k]['floor'] = $quantities_indexed_by_id[$items_sales_data[$k]['item_id']]['floor'];
		}
