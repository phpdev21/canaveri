...
class Customer extends Person
{
    ...
    function get_customer_search_suggestions($search, $deleted = 0, $limit = 25)
    {
        ...
        foreach ($temp_suggestions as $key => $value) {
            $suggestions[] = array('value' => $key, 'label' => $value['name'], 'avatar' => $value['avatar'], 'subtitle' => $value['email'],"rep_exp" =>$value['rep_exp']);
        }
    ...
    function get_displayable_columns()
    {
        $columns = array(
            ...
            'med_account_number' => array('sort_column' => 'med_account_number', 'label' => lang('customers_club_member_number')),
