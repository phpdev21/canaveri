...
function get_item_data_row($item,$controller)
{
	...
	if(!$params['deleted'])
	{
		...
		$table_data_row.= '<li>'. anchor($controller_name."/labels/$item->item_id?redirect=items", '<i class="ion-android-print"></i> ' .  lang('common_print') .' ' . lang('common_label') , array('class'=>'','title'=>lang('common_label'))).'</li>';
