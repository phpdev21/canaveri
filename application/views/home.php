	...
	<div class="row">
		...
		<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
			<a href="<?php echo site_url('items'); ?>">
				<div class="dashboard-stats">
					<div class="left">
						<h3 class="flatGrayc"><?php echo $total_items; ?></h3>
						<h4><?php echo lang('common_total')." ".lang('module_items'); ?></h4>
					</div>
					<div class="right flatGray">
		...
		<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-piluku" style="max-height: 109px;overflow: auto;">
					<div class="panel-heading">
					<h6 class="panel-title">
						<?php echo lang('appointment_queue'); ?>
					</h6>
					</div>
