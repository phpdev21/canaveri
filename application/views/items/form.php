        ...
        <div
            ...
            <div class="modal-item-info padding-left-10">
                <div class="modal-item-details margin-bottom-10">
                    ...
                    <?php } else { ?>
                    <span
                        class="modal-item-name"><?php echo H($item_info->name) . ' [' . lang('common_id') . ': ' . $item_info->item_id . ']'; ?></span>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-piluku">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="ion-information-circled"></i>
                    <?php echo lang("common_item_information"); ?>
                    <small>(<?php echo lang('common_fields_required_message'); ?>)</small>
                </h3>

                <div class="panel-options custom pagination pagination-top hidden-print text-center"
                    id="pagination_top">
                    <?php
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        ...
                        <div>
                            <a href="javascript:void(0);"
                                id="add_category"><?php echo lang('common_add_category'); ?></a>
                        </div>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <?php echo form_label(lang('common_brand') . ':', 'brand_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php 
                         echo form_dropdown('brand_id', $supplier_brands, $item_info->brand_id, 'class="form-control form-inps" id="brand_id"');
                        ?>
                ...
                <div class="form-group">
                    <?php echo form_label(lang('common_package_number') . ':', 'product_id', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <table id="addtional_package_number" class="table">
                            <thead>
                                <tr>
                                    <th><?php echo lang('common_package_number'); ?></th>
                                    <th><?php echo lang('common_delete'); ?></th>
                                </tr>
                            </thead>
                            <tbody>

                                <?php if (isset($item_info) && $item_info) { 
                                        $product_ids = json_decode($item_info->product_id);
                                    ?>
                                <?php foreach ($product_ids as $product_id) { ?>
                                <tr>
                                    <td><input type="text" class="form-control form-inps" size="50" name="product_id[]"
                                            value="<?php echo H($product_id); ?>" /></td>
                                    <td>
                                        <a class="delete_addtional_item_number"
                                            href="javascript:void(0);"><?php echo lang('common_delete'); ?></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php } ?>
                        ...
                        <a href="javascript:void(0);"
                            id="add_addtional_package_number"><?php echo lang('items_add_package_number'); ?></a>
                    </div>
                </div>

                <div class="form-group">
                    <label
                        class="col-sm-3 col-md-3 col-lg-2 control-label"><?php echo lang('common_source_package_number') ?></label>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <table id="additional_item_numbers" class="table">
                            <thead>
                                <tr>
                                    <th><?php echo lang('common_source_package_number'); ?></th>
                                    <th><?php echo lang('common_delete'); ?></th>
                                </tr>
                            </thead>
                        ...
                        <a href="javascript:void(0);"
                            id="add_addtional_item_number"><?php echo lang('items_add_source_package_number'); ?></a>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <?php echo form_label(lang('common_description') . ':', 'description', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide desc-main')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                ...
                <div class="form-group" id="mmj_weight_part">
                    <?php echo form_label(lang('items_mmj_weight') . ':', 'mmj_weight', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label required wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_input(array(
                                'name' => 'mmj_weight',
                                'id' => 'mmj_weight',
                                'placeholder' => lang('mmj_weight_placeholder'),
                                'class' => 'form-control form-inps',
                                'value' => $item_info->mmj_weight ? to_quantity($item_info->mmj_weight, false) : '')
                        ); ?>
                    </div>
                </div>
                ...
                <div class="form-group <?php if (!$item_info->is_series_package) {
                    echo 'hidden';
                ...
                <div class="form-group">
                    <?php echo form_label(lang('items_is_serialized_new') . ':', 'is_serialized', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_checkbox(array(
                                'name' => 'is_serialized',
                                'id' => 'is_serialized',
                ...
                <div id="serial_container" class="form-group serial-input <?php if (!$item_info->is_serialized) {
                    echo 'hidden';
                } ?>">
                    <label
                        class="col-sm-3 col-md-3 col-lg-2 control-label"><?php echo lang('items_batch_numbers') ?></label>
                    <div class="col-sm-9 col-md-9 col-lg-9">

                        <table id="serial_numbers" class="table">
                            <thead>
                                <tr>
                                    <th><?php echo lang('items_batch_number'); ?></th>
                                    <th><?php echo lang('common_cost_price'); ?></th>
                                    <th><?php echo lang('common_qty_gram_count'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="text" class="form-control form-inps" size="40"
                                            name="serial_numbers[]"
                                            value="<?php echo H($serial_item_number['serial_number']); ?>" /></td>
                                    <td><input type="text" class="form-control form-inps" size="20"
                                            name="serial_number_cost_prices[]"
                                            value="<?php echo H($serial_item_number['cost_price'] !== NULL ? to_currency_no_money($serial_item_number['cost_price']) : ''); ?>" />
                                    </td>
                                    <td><input type="text" class="form-control form-inps" size="20"
                                            name="serial_number_qty[]"
                                            value="<?php echo H($serial_item_number['qty'] !== NULL ? to_currency_no_money($serial_item_number['qty']) : ''); ?>" />
                                    <td><input type="text" class="form-control form-inps datepicker" size="20"
                                            name="serial_number_date[]"
                                            value="<?php echo H($serial_item_number['date'] !== NULL ? date('m/d/Y',strtotime($serial_item_number['date'])) : ''); ?>" />
                                    ...
                                    <td><a class="delete_serial_number"
                        ...
                        <a href="javascript:void(0);"
                            id="add_serial_number"><?php echo lang('items_add_batch_number'); ?></a>
                ...
                <div class="form-group <?php if (!$item_info->verify_age) {
                        echo 'hidden';
...
function showOrHideMMJWeight($category_id) {
    $.ajax({
        url: '<?php echo site_url("items/get_category_sold_type_and_mmj_info/");?>' + $category_id,
        type: 'GET',
        success: function(data) {
            var {
                enable_mmj_weight
            } = data;
            if (parseInt(enable_mmj_weight) == 1) {
                // $("#mmj_weight").val('');
                $("#mmj_weight_part").show();
            } else {
                $("#mmj_weight_part").hide();
            }
        },
...
$(document).ready(function() {
    ...
    //Initial check if category is Edible
    var $selected_category = "<?php echo $item_info->category_id; ?>";
    if ($selected_category) {
        showOrHideMMJWeight($selected_category);
    } else {
        $("#mmj_weight_part").hide();
    }
    ...
    $("#supplier_id").change(function() {
        ...
        $.ajax({
            url: '<?php echo site_url("Suppliers/getSupplierBrands");?>' + '?supplierId=' +
                encodeURIComponent(supplier_id),
            type: 'GET',
            error: function() {
                console.error('error');
            },
            success: function(res) {
                ...
                $.each(res, function(key, value) {
                    $('#brand_id').append('<option value="' + value
                        .supplier_brand_id + '">' + value.brand + '</option>');
                });
            }
        });
    });
    ...
    $("#add_serial_number").click(function() {
        $("#serial_numbers tbody").append(
            '<tr><td><input type="text" class="form-control form-inps" size="40" name="serial_numbers[]" value="" /></td><td><input type="text" class="form-control form-inps" size="40" name="serial_number_cost_prices[]" value="" /></td><td><input type="text" class="form-control form-inps" size="20" name="serial_number_qty[]" value="" /></td><td><input type="text" class="form-control form-inps datepicker" size="20" name="serial_number_date[]" value=""/></td>&nbsp;</td></tr>'
            );
    ...
    $("#add_addtional_package_number").click(function() {
        $("#addtional_package_number tbody").append(
            '<tr><td><input type="text" class="form-control form-inps" size="40" name="product_id[]" value="" /></td><td>&nbsp;</td></tr>'
            );
    });
    ...
    $("#category_id").change(function(e) {
        ...
        showOrHideMMJWeight($category_id);
    });
    ...
    $('#item_form').validate({
        ...
        submitHandler: function(form) {
            ...
            $.post('<?php echo site_url("items/check_duplicate");?>', {
                ...
                if (data.duplicate) {
                    bootbox.confirm(
                        <?php echo json_encode(lang('common_items_duplicate_exists'));?>,
                        function(result) {
                            if (result) {
        ...
        messages: {
            ...
            item_number: {
                remote: function() {
                    var link =
                        <?php echo json_encode('<a id="item_number_validation_link" target="_blank" href="#">' . lang('common_item_info') . '</a>')?>;
            ...
            product_id: {
                remote: function() {
                    var link =
                        <?php echo json_encode('<a id="product_id_validation_link" target="_blank" href="#">' . lang('common_item_info') . '</a>')?>;
            ...
            mmj_weight: <?php echo json_encode(lang('mmj_weight_required')); ?>,
...
// $("#weight").on('input propertychange paste load', function() {
//     showHideWeightUnit(this.value);
// });
