				...
				<div class="tab-pane active" id="ItemInfo">
					<div class="panel panel-piluku">
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<?php if($item_info->product_id) { 
									$product_ids = json_decode($item_info->product_id);	
								?><tr><td colspan="2"><?php echo lang('common_package_number'); ?></td></tr> 
								<?php foreach($product_ids as $product_id) { 
									?>
									<tr><td colspan="2"><?php echo H($product_id); ?></td></tr>
								<?php } ?>
							<?php } ?>
							...
							<?php if (isset($additional_item_numbers) && $additional_item_numbers->num_rows() > 0) {?>
								<tr> <td colspan="2"><strong><?php echo lang('common_source_package_number'); ?></strong></td></tr>
