            ...
            <?php if ($receipt_title && (!isset($sale_type) || $sale_type != lang('common_estimate'))) {?>
			        ...
			        <div class="col-md-12 col-sm-12 col-xs-12">
			          ...
			          <?php if(isset($delivery_person_info)) { ?>
				        <ul class="list-unstyled invoice-address" style="margin-bottom:10px;">
                                    ...
                                    <?php if (!empty($full_delivery_address) && strlen($full_delivery_address) > 10) {
                                        echo '<li>'.address($full_delivery_address).'</li>';
                                    } ?>
				...
				foreach(array_reverse($cart_items, true) as $line=>$item)
				{
					...
					$item_tax_amount = ($price_including_tax - $price_excluding_tax);
					 ...
					 // item weight
					 if ($item->quantity > 0 &&  isset($item->variation_name) && $item->variation_name != ""){
			    ...
			    <div class="invoice-footer gift_receipt_element">
					...
					<div class="row">
						<?php if ($number_of_items_sold) { ?>
				            <div class="col-md-offset-4 col-sm-offset-4 col-md-6 col-sm-6 col-xs-8">
				                <div class="invoice-footer-heading custom-heading"><?php echo lang('common_weight_sold','',array(),TRUE); ?></div>
				            </div>
				            <div class="col-md-2 col-sm-2 col-xs-4">
				                <div class="invoice-footer-value invoice-total"><?php echo array_sum($total_items_weight).' Gram'; ?></div>
				            </div>
						<?php } ?>	
			        </div> 
					...
					<?php if ($amount_change >= 0) {?>
						<div class="row">
				            <div class="col-md-offset-8 col-sm-offset-8 col-xs-offset-2 col-md-2 col-sm-2 col-xs-6">
				                <div class="invoice-footer-heading head-before-count"><?php echo lang('common_change_due','',array(),TRUE); ?></div>
				            </div>
				            <div class="col-md-2 col-sm-2 col-xs-4">
