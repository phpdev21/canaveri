	...
	<?php } ?>
		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<!-- This is a temp impl, as the initial config scripts will define a site as processor or retailer -->
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">
						<?php echo form_label(lang('cas_config_store_type').':', 'cas_store_type_config',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_dropdown('cas_store_type', array(
								NULL           => 'Select Store Type',
								'Processor'    => lang('cas_config_processor'),
								'Retailer'     => lang('cas_config_retailer'),
                                'Grower'       => lang('cas_config_grower'),
							),$this->config->item('cas_store_type')===NULL ? '' : $this->config->item('cas_store_type'), 'class="form-control" id="cas_store_type"');?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">
						<?php echo form_label(lang('cas_config_company_title').':', 'company',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
							<?php echo form_input(array(
								'class'=>'validate form-control form-inps',
								'name'=>'cas_company_title',
								'id'=>'cas_company_title',
								'value'=>$this->config->item('cas_company_title')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">
						<?php echo form_label(lang('cas_config_license_number').':', 'company',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label required')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
							<?php echo form_input(array(
								'class'=>'validate form-control form-inps',
								'name'=>'cas_license_number',
								'id'=>'cas_license_number',
								'value'=>$this->config->item('cas_license_number')));?>
						</div>
					</div>
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_company')) ?>">
						<?php echo form_label(lang('common_metrc_api_key').':', 'metrc_api_key',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10 input-field">
						<?php echo form_input(array(
							'class'=>'form-control form-inps',
							'name'=>'metrc_api_key',
							'id'=>'metrc_api_key',
							'value'=>$this->config->item('metrc_api_key')));?>
						</div>
					</div>
				</div>
			</div>	
				...
				<div class="panel-body">
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_payment')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							<a href="#" class="btn btn-primary payment_types"><?php echo lang('common_helox'); ?></a> 
                            ...
                            <a href="#" class="btn btn-primary payment_types" title="Term is only used by Receiving."><?php echo lang('common_term'); ?></a>
							<br>
							<br>
							<?php echo form_input(array(
								'class'=>'form-control form-inps',
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_helox_prefix')) ?>">	
						<?php echo form_label(lang('config_helox_prefix').':', 'additional_helox_prefix',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_input(array(
								'class'=>'form-control form-inps',
								'name'=>'helox_payment_prefix',
								'id'=>'helox_payment_prefix',
								'value'=>$this->config->item('helox_payment_prefix')));?>		
						</div>
					</div>
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_payment')) ?>">	
						...
						<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_dropdown('default_payment_type_recv', $receiving_payment_options, $this->config->item('default_payment_type_recv'),'class="form-control" id="default_payment_type_recv"'); ?>
						</div>
					</div>
				...
				<div class="panel-body">
					...
					<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">	
						...
						<?php echo form_checkbox(array(
							...
							'id'=>'track_check',
							'value'=>'common_helox',
							'checked'=>in_array('common_helox',$track_payment_types)));?>
		...
		<div class="col-md-12">
            ...
            <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
						...
						<div class="form-group"  data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">
							<?php echo form_label(lang('config_grams_per_pound').':', null,array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 form-text">
								<?php echo form_input(array(
									'name'=>'grams_per_pound',
									'id'=>'grams_per_pound',
									'placeholder' => to_quantity(null),
									'value' => to_quantity($grams_per_pound),
									'class'=>'form-control'
									)
								);?>
							</div>
						...
						<div class="form-group"  data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">
							<?php echo form_label(lang('config_ounce_per_pound').':', null,array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
							<div class="col-sm-9 col-md-9 col-lg-10 form-text">
								<?php echo form_input(array(
									'name'=>'ounce_per_pound',
									'id'=>'ounce_per_pound',
									'placeholder' => to_quantity(null),
									'value' => to_quantity($ounce_per_pound),
									'class'=>'form-control'
									)
								);?>
							</div>
    ...
    <?php
      ...
      <div class="col-md-12 woo_settings ecom_settings <?php echo $hidden_class; ?>">
	     ...
	     <div class="col-md-12">
			...
			<!--- Items Purchase availablity  -->
			<div class="col-md-12">
				<div class="panel panel-piluku">
					<div class="panel-heading">
						<?php echo create_section(lang('config_items_purchase_controllability'), 'store-configuration-options', 'section-purchase-settings')  ?>
					</div>	
					<div class="panel-body">
							<div class="form-group px-4" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">
							<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_currency')) ?>">	
					<?php echo form_label(lang('config_category_denoms').':', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
						<div class="table-responsive col-sm-9 col-md-4 col-lg-4">
						<table id="category_limit" class="table">
							<thead>
								<tr>
								<th><?php echo lang('config_category_head'); ?></th>
								<th><?php echo lang('config_category_limit'); ?></th>
								<th><?php echo lang('common_delete'); ?></th>
								</tr>
							</thead>
							<tbody>
							<?php 
								$purchase_categories = json_decode($section_purchase_settings);
								$count = 1;
								foreach($purchase_categories as $purchase_category) { ?>
								<tr>
									<td><input type="text" name="category_limit_name[]" class="form-control" value="<?php echo H($purchase_category[0]); ?>" /></td>
									<td><input type="text" name="category_limit_value[]" class="form-control" value="<?php echo H($purchase_category[1]); ?>" /></td>
									<td><a class="delete_category_denom text-primary" data-id="<?php echo H($count); ?>" href="javascript:void(0);"><?php echo lang('common_delete'); ?></a></td>
									<input type="hidden" name="category_limit_ids[]" value="<?php echo H(	$count); ?>" />
								</tr>
							<?php
								$count++;
								 } ?>
						...
						<a href="javascript:void(0);" id="add_category"><?php echo lang('config_add_catgory_denom'); ?></a>
						</div>
					</div>
				</div>	
						</div>
...
foreach($categories as $category){ 
	$cate .= '<option value="'.$category.'">'.$category.'</option>';
} 
?>
...
{	
	...
	$(".delete_category_denom").click(function()
	{
		var id = $(this).data('id');
		$("#category_limit").append('<input class="deleted_denmos_category" type="hidden" name="deleted_denmos_category[]" value="'+id+'" />');
	...
	$("#add_category").click(function()
	{
		...
		$("#category_limit tbody").append('<tr><td><select name="category_limit_name[]" class="form-control" >'+category+'</select></td><td><input type="text" class="form-control" name="category_limit_value[]" value=""  placeholder="Weight in gram"/></td><td>&nbsp;</td><input type="hidden" name="category_limit_ids[]" /></tr>');
	});
