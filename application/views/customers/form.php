    ...
    <div class="col-md-12">
                ...
                <div class="panel-body">
                    <div class="user-badge">
                        ...
                        <ul class="list-inline pull-right">
                            ...
                            <li><a target="_blank"
                                   href="<?php echo site_url('reports/generate/specific_customer?report_type=complex&start_date=' . $six_months_ago . '&start_date_formatted=' . date(get_date_format() . ' ' . get_time_format(), strtotime($six_months_ago)) . '&end_date=' . $today . '&end_date_formatted=' . date(get_date_format() . ' ' . get_time_format(), strtotime(date('Y-m-d') . ' 23:59:59')) . '&customer_id=' . $person_info->person_id . '&sale_type=all&export_excel=0'); ?>"
        ...
        <div class="panel panel-piluku">
            ...
            <div class="panel-body">
                ...
                <?php if ($this->config->item('cas_store_type') == 'Processor') { ?>
                    <div class="form-group">
                ...
                <div class="tax-container main <?php if (!$person_info->override_default_tax) {
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 col-md-3 col-lg-2 control-label wide"
                               for="tax_percent_name_1">&nbsp;</label>
                        <div class="col-sm-9 col-md-9 col-lg-10">
                            <?php echo form_input(array(
                                    'name' => 'tax_percents[]',
                ...
                <div class="row">
                    ...
                    <div class="col-sm-11 col-md-11 col-lg-11">                       
                        <a target="_blank"
                        href="<?php echo site_url('appointments/view/-1'); ?>"
                        class="btn btn-primary"><?php echo lang('appointments_customer'); ?></a>
                    </div>
                </div>
...
<script type='text/javascript'>
    ...
    function setAge(DOB) {
        ...
        if (birthDate instanceof Date && !isNaN(birthDate) && DOB.trim().length === 10) {
    ...
    $(document).ready(function () {
        ...
        $('#age').val(setAge($('#date_of_birth').val()));
