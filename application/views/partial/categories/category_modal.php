    ...
    <div class="modal-dialog customer-recent-sales">
      	<div class="modal-content">
	        ...
	        <div class="modal-body">
				...
				<div class="form-group">
					<?php echo form_label(lang('enable_mmj_weight').':', 'enable_mmj_weight',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
					<div class="col-sm-9 col-md-9 col-lg-9">
						<?php echo form_checkbox(array(
							'name'=>'enable_mmj_weight',
							'id'=>'enable_mmj_weight',
							'class'=>'enable_mmj_weight',
							'value'=>1,
							'checked' => FALSE,
						));?>
						<label for="enable_mmj_weight"><span></span></label>
					</div>
				</div>
