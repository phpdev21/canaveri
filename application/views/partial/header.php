...
<head>
    ...
    <title><?php 
		 ...
		 echo !is_on_demo_host() ?  $company.' -- '.lang('common_powered_by').' CAS.420 Point Of Sale' : 'Demo - CAS.420 Point Of Sale | Easy to use Online POS Software'  ?></title>
				...
				<nav class="navbar navbar-default top-bar">
					...
					<?php } ?>
						...
						<li class="dropdown">
							...
							<li>
									<a tabindex = "-1" id="support_link" target="_blank" href="https://canaveri.com/"><i class="ion-help-buoy"></i><span class="text"><?php echo lang('common_support'); ?></span></a>									
							</li>
