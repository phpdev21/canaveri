...
<div class="form-group">
    <div class="col-sm-3 col-md-3 col-lg-2 control-label">
	    <?php echo form_label(lang('reports_date_range').':'); ?>
    </div>	
	<div id="report_date_range_complex<?php echo $compare_suffix; ?>" class="col-sm-9 col-md-9 col-lg-10 ">
		<div class="row">
			<div class="col-md-4">
       ...
       <input type="text" class="form-control end_date" name="end_date<?php echo $compare_suffix; ?>" 
	   id="end_date<?php echo $compare_suffix; ?>" 
	   <?php echo isset($end_date_value) ? "value='$end_date_value'" : "value='".$this->input->get('end_date_'.$compare_middle_suffix.'formatted')."'" ?>>
      	</div>	
			</div>
		</div>
	</div>	
...
<script>	
	...
	{
		// $("#start_date<?php //echo $compare_suffix; ?>").datepicker({
		// 	format: 'mm/dd/yyyy',
		// 	startDate: new Date(),
		// 	endDate: '+0d',
		// 	autoclose: true
		...
		$("#start_date<?php 
		echo $compare_suffix; ?>").click(function(){
