	...
	<div class="col-md-12">
		...
		<div class="panel panel-piluku">
			...
			<div id="options" class="panel-body" <?php echo (isset($output_data) && $output_data) ? 'style="display:none;"' : ''; ?>>
				...
				<form class="form-horizontal form-horizontal-mobiles" id="report_input_form" method="get" action="<?php echo site_url('state_reporting/generate/' . $report); ?>">
					<?php
					$this->load->helper('view');
					foreach ($input_params as $input_param) {
						load_cleaned_view('state_reporting/inputs/' . $input_param['view'], $input_param);
					}
					?>
